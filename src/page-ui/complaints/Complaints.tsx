...
import { useGetUSerMeQuery, useGetUsersQuery } from "@/integration";
...
} from "@/integration/api/complaintApi";
...
export const Information = () => {
  ...
  const { data: single_user } = useGetUSerMeQuery({});
  ...
  return (
    <>
      <header className="flex justify-between items-center border-b-2 border-b-[#FFCC15] pb-5 px-5 mt-5 rounded-[30px] fixed top-0 left-0 w-full">
