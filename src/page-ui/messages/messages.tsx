...
export const MessagesUI = () => {
  ...
  const { data: singleUser } = useGetUSerMeQuery([]);
  ...
  return (
    <>
      <header className="border-b-2 border-b-[#FFCC15] pb-5 px-5 rounded-[30px] mt-4 fixed left-0 top-0 w-full">
      ...
      <Drawer>
        ...
        <DrawerContent className="bg-[#1C2C57] flex flex-col justify-between min-h-[45vh]">
          ...
          <div className="px-4 flex-grow overflow-y-auto">
            ...
            >
              <SelectTrigger className="w-full mt-8 mb-36 text-white">
