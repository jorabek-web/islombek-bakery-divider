...
import { BakeryBakeRequest, BakeryBakeResponse, BakeryBreadsRequest, BakeryBreadsResponse, BakeryDivideRequest, BakeryDivideResponse, BakeryDoughResponse, BakeryDoughsRequest, BakeryRedirectRequest, BakeryRedirectResponse, BakeryResponse } from "./types";
...
export const BakeryApi = baseApi.injectEndpoints({
    endpoints: (build) => ({
        ...
        bakeryRedirect: build.mutation<BakeryRedirectResponse[], BakeryRedirectRequest>({
            query: ({ dough, driver }) => ({
...
export const { useBakeryQuery, useSingleBakeryQuery, useLazyBakeryDoughsQuery, useLazyBakeryBreadsQuery, useBakeryDoughsQuery, useBakeryBreadsQuery, useBakeryDivideMutation, useBakeryBakeMutation, useBakeryRedirectMutation } = BakeryApi;